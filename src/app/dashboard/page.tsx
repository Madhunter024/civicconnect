...
const CivicDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 -m-6">
      {/* Header */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <nav className="flex space-x-8 mb-8">
          {[
            ...
            { id: 'pending', label: 'Pending Issues', icon: Clock },
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900">{pendingIssues.length}</p>
                  </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900">{resolvedIssues.length}</p>
                  </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 font-medium flex items-center justify-center space-x-2"
                >
