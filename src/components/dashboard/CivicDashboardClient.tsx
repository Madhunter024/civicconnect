...
const CivicDashboardClient = ({ user, pendingIssues, resolvedIssues }: CivicDashboardClientProps) => {
  ...
  const handleSubmitIssue = () => {
    ...
    // Here you would typically call an action to save the new issue
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-foreground">
                      { (pendingIssues.length + resolvedIssues.length) > 0 ?
                        Math.round((resolvedIssues.length / (pendingIssues.length + resolvedIssues.length)) * 100)
                        : 0
                      }%
                    </p>
                  </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setNewIssue({...newIssue, description: e.g.target.value})}
                  rows={4}
                  className="w-full px-4 py-2 border border-border bg-background rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
...
export default CivicDashboardClient;
